...
const category = categories.find(c => c.slug === 'manga-translation');
const companies = category?.companies || [];

const MangaTranslationPage: React.FC = () => {
                  ...
                  return (
                    <div
                      ...
                      onClick={() => {
                        ...
                        audio.play();
                        setTimeout(() => navigate(`/manga-translation/${company.id}`), 120);
                      }}
                    >
...
export default MangaTranslationPage; 