...
const category = categories.find(c => c.slug === 'autonomous-vehicles');
const companies = category?.companies || [];

const AutonomousVehiclesPage: React.FC = () => {
                  ...
                  return (
                    <div
                      ...
                      onClick={() => {
                        const audio = new Audio('/sounds/click-1.mp3');
                        audio.play();
                        setTimeout(() => navigate(`/autonomous-vehicles/${company.id}`), 120);
                      }}
                    >
