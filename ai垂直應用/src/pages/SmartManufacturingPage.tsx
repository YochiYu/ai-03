...
const category = categories.find(c => c.slug === 'smart-manufacturing');
const companies = category?.companies || [];

const SmartManufacturingPage: React.FC = () => {
                  ...
                  return (
                    <div
                      ...
                      onClick={() => {
                        ...
                        audio.play();
                        setTimeout(() => navigate(`/smart-manufacturing/${company.id}`), 120);
                      }}
                    >
