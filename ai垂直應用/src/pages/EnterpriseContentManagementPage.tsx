...
const category = categories.find(c => c.slug === 'enterprise-content-management');
const companies = category?.companies || [];

const EnterpriseContentManagementPage: React.FC = () => {
                  ...
                  return (
                    <div
                      ...
                      onClick={() => {
                        ...
                        audio.play();
                        setTimeout(() => navigate(`/enterprise-content-management/${company.id}`), 120);
                      }}
                    >
...
export default EnterpriseContentManagementPage; 