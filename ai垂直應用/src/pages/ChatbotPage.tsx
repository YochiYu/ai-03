...
const companies = [
  { id: 'poe', name: 'Poe', logo: '/logos/chatbot/poe.png' },
  { id: 'character', name: 'Character.AI', logo: '/logos/chatbot/character.png' },
];
                  ...
                  return (
                    <div
                      ...
                      onClick={() => {
                        ...
                        audio.volume = 1.0;
                        audio.play();
                        setTimeout(() => navigate(`/chatbot/${company.id}`), 120);
                      }}
                      ref={el => {
