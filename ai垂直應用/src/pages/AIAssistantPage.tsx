...
const companies = [
  { id: 'adept', name: 'Adept', logo: '/logos/企業AI助理/adept.png' },
  { id: 'ema', name: 'EMA', logo: '/logos/企業AI助理/ema.png' },
  { id: 'pryon', name: 'Pryon', logo: '/logos/企業AI助理/pryon.png' },
];
                  ...
                  return (
                    <div
                      ...
                      onClick={() => {
                        ...
                        audio.volume = 1.0;
                        audio.play();
                        setTimeout(() => navigate(`/enterprise-ai-assistant/${company.id}`), 120);
                      }}
                      ref={el => {
