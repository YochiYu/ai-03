...
const companies = [
  { id: 'ideogram', name: 'Ideogram', logo: '/logos/創作(生成式AI)/ideogram.png' },
  { id: 'lumaai', name: 'Luma AI', logo: '/logos/創作(生成式AI)/luma ai.png' },
  { id: 'midjourney', name: 'Midjourney', logo: '/logos/創作(生成式AI)/midjourney.png' },
  { id: 'pika', name: 'Pika', logo: '/logos/創作(生成式AI)/pika.png' },
  { id: 'runway', name: 'Runway', logo: '/logos/創作(生成式AI)/runway.png' },
  { id: 'stability', name: 'Stability', logo: '/logos/創作(生成式AI)/stability.png' },
  { id: 'synthesia', name: 'Synthesia', logo: '/logos/創作(生成式AI)/synthesia.png' },
];
...
const GenerativeAIPage: React.FC = () => {
  ...
  // Group companies into rows of 2
  const companyRows = [];
                  ...
                  return (
                    <div
                      ...
                      onClick={() => {
                        ...
                        audio.volume = 1.0;
                        audio.play();
                        setTimeout(() => navigate(`/generative-ai/${company.id}`), 120);
                      }}
                      ref={el => {
                    ...
                    >
                      ...
                      >
                        <img src={company.logo} alt={company.name} className="w-[192px] h-[144px] object-contain mb-2" />
                      </div>
                    </div>
                  );
                })}
