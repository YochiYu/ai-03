...
const category = categories.find(c => c.slug === 'crm-sales');
const companies = category?.companies || [];

const CrmSalesPage: React.FC = () => {
                  ...
                  return (
                    <div
                      ...
                      onClick={() => {
                        ...
                        audio.play();
                        setTimeout(() => navigate(`/crm-sales/${company.id}`), 120);
                      }}
                    >
