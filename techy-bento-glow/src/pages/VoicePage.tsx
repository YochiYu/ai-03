...
const companies = [
  { id: 'assemblyai', name: 'AssemblyAI', logo: '/logos/語音/assemblyai.png' },
  { id: 'elevenlabs', name: 'ElevenLabs', logo: '/logos/語音/iieivenlabs.png' },
  { id: 'soundhound', name: 'SoundHound', logo: '/logos/語音/soundhoundai.png' },
  { id: 'suno', name: 'Suno', logo: '/logos/語音/suno.png' },
];
                  ...
                  return (
                    <div
                      ...
                      onClick={() => {
                        ...
                        audio.volume = 1.0;
                        audio.play();
                        setTimeout(() => navigate(`/voice/${company.id}`), 120);
                      }}
                      ref={el => {
