...
const companies = [
  { id: 'glean', name: 'Glean', logo: '/logos/搜尋/glean.png' },
  { id: 'hebbia', name: 'Hebbia', logo: '/logos/搜尋/hebbia.png' },
  { id: 'perplexity', name: 'Perplexity', logo: '/logos/搜尋/perplexity.png' },
  { id: 'twelvelabs', name: 'TwelveLabs', logo: '/logos/搜尋/twelvelabs.png' },
];
                  ...
                  return (
                    <div
                      ...
                      onClick={() => {
                        ...
                        audio.volume = 1.0;
                        audio.play();
                        setTimeout(() => navigate(`/search/${company.id}`), 120);
                      }}
                      ref={el => {
