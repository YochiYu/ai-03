  ...
  return (
    <div
      className={`
        ...
        hover:scale-[1.030]
        shadow-2xl
        min-h-[300px] min-w-[390px] max-h-[300px] max-w-[390px]
        ${glow}
        ${className}
      `}
      style={{
    ...
    >
      ...
      <div className="relative z-10 flex flex-col items-center justify-center w-full h-full p-8" style={{width:390, height:220}}>
        <span className="text-white font-semibold font-tech text-center break-words drop-shadow-[0_2px_8px_rgba(0,0,0,0.13)] tracking-wider" style={{fontSize: 62}}>
